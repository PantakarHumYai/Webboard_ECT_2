...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><i class="bi bi-house"></i> Home</a>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <i class="bi bi-person-walking"></i>  <?php echo $_SESSION['username']; ?>
          </a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="logout.php"><i class="bi bi-door-open"></i> ออกจากระบบ</a></li>
          </ul>
        </li>
        <?php } ?>
    </ul>
